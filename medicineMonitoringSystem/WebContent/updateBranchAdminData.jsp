...
try{
	...
	String sql="SELECT * FROM BRANCH_MEDICINES";
...
<td><button style='font-size:15px'>edit <i class='fas fa-edit'></i></button></td>
<td><button style='font-size:15px'>delete<i class='fas fa-delete'></i></button></td>
</tr>
<% 	
	}
	connection.close();
